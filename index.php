...
<body>
    ...
    <nav class="navbar">
        <div class="container">
            <div class="logo">
                <img src="/raysofgrace/images/logo.png" alt="RAYS OF GRACE Junior School">
                <span>
                    RAYS OF GRACE
            ...
            <div class="class-grid">
                ...
                <div class="class-card">
                    ...
                    <div class="class-body">
                        ...
                        <a href="lessons.php?class=p1-p3" class="view-lessons">
                ...
                <div class="class-card">
                    ...
                    <div class="class-body">
                        ...
                        <a href="lessons.php?class=p4-p7" class="view-lessons">
                            View Lessons <i class="fas fa-arrow-right"></i>
                        </a>
                    </div>
                </div>
    ...
    <section id="subjects" class="subjects">
        <div class="container">
            ...
            <div class="subject-tabs">
                <button class="tab-btn active" onclick="showSubjects('lower')">Lower Primary (P.1-P.3)</button>
                <button class="tab-btn" onclick="showSubjects('upper')">Upper Primary (P.4-P.7)</button>
            </div>
